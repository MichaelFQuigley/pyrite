...
static bits_t flags_num_bits_size =
    flags_num_bits_obj - flags_num_bits_is_marked;
...
static inline void lang_core_set_obj_is_marked(gc_base_t* this,
                                               uint64_t is_marked) {
  this->flags &= ~(1);
 ...
 *
 * On failure, null is returned and nothing is added to the linked lists or
 *stacks.
 *
